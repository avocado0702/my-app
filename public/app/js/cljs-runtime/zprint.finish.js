...
zprint.finish.no_style_map = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"f","f",-1597136552),(function (p1__16207_SHARP_){
if(cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__16207_SHARP_,new cljs.core.Keyword(null,"none","none",1333468478))){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reverse","reverse",-888455266)], null),p1__16207_SHARP_);
} else {
 ...
 */
zprint.finish.within_QMARK_ = (function zprint$finish$within_QMARK_(n,p__16216){
var vec__16217 = p__16216;
var low = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16217,(0),null);
var high = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16217,(1),null);
return (((n >= low)) && ((n <= high)));
});
/**
 ...
 */
zprint.finish.ground_color_to_style = (function zprint$finish$ground_color_to_style(p__16223,s,color,element,idx){
var map__16225 = p__16223;
var map__16225__$1 = cljs.core.__destructure_map(map__16225);
var style_map = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16225__$1,new cljs.core.Keyword(null,"style-map","style-map",1488693527));
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16225__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var select = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16225__$1,new cljs.core.Keyword(null,"select","select",1147833503));
...
var G__16237 = (function (){var or__5002__auto__ = color;
...
var fexpr__16236 = (function (){var G__16238 = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(element,new cljs.core.Keyword(null,"cursor-element","cursor-element",-616791907)))?(function (){
...
:(cljs.core.truth_((function (){var and__5000__auto__ = focus;
...
return (style_map.cljs$core$IFn$_invoke$arity$1 ? style_map.cljs$core$IFn$_invoke$arity$1(G__16238) : style_map.call(null, G__16238));
})();
return (fexpr__16236.cljs$core$IFn$_invoke$arity$1 ? fexpr__16236.cljs$core$IFn$_invoke$arity$1(G__16237) : fexpr__16236.call(null, G__16237));
} else {
return null;
}
});
 ...
 */
zprint.finish.add_length = (function zprint$finish$add_length(p__16248){
var vec__16249 = p__16248;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16249,(0),null);
var style = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16249,(1),null);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16249,(2),null);
 ...
 *   which are in focus.
 */
zprint.finish.gc_vec_to_style_vec = (function zprint$finish$gc_vec_to_style_vec(ctx,idx,p__16254){
var vec__16255 = p__16254;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16255,(0),null);
var keyword_color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16255,(1),null);
var element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16255,(2),null);
...
if(doing_nil_QMARK_){
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,zprint.finish.gc_vec_to_style_vec(ctx,(0),(function (){var or__5002__auto__ = last_elide;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
var G__16426 = cljs.core.next(ssv);
var G__16427 = (this_ssv == null);
var G__16428 = (cljs.core.truth_(this_elide)?this_elide:last_elide);
...
var vec__16301 = cljs.core.first(remaining_cvec);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(0),null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(1),null);
var element_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16301,(2),null);
...
var G__16431 = cljs.core.next(remaining_cvec);
var G__16432 = new_idx;
var G__16433 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new_idx);
remaining_cvec = G__16431;
idx = G__16432;
out = G__16433;
continue;
}
 ...
 */
zprint.finish.replace_focus_w_cursor = (function zprint$finish$replace_focus_w_cursor(gcw_vec,p__16327,cursor_vec){
var vec__16328 = p__16327;
var focus_start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16328,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16328,(1),null);
var focus_vec = vec__16328;
...
var vec__16331 = cljs.core.split_at(focus_start,gcw_vec);
var front = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16331,(0),null);
var back = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16331,(1),null);
 ...
 */
zprint.finish.color_style = (function zprint$finish$color_style(p__16334){
var vec__16335 = p__16334;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16335,(0),null);
var color = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16335,(1),null);
if((color == null)){
return s;
} else {
...
(zprint.finish.cursor_style.cljs$core$IFn$_invoke$arity$2 = (function (p__16354,existing_count){
var vec__16355 = p__16354;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16355,(0),null);
var cursor = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16355,(1),null);
...
var cursor__$1 = (function (){var x__5090__auto__ = zprint.finish.floor((0),(len - (1)));
var y__5091__auto__ = cursor;
return ((x__5090__auto__ < y__5091__auto__) ? x__5090__auto__ : y__5091__auto__);
})();
return cljs.core.filterv((function (p1__16343_SHARP_){
return (!(cljs.core.empty_QMARK_(cljs.core.first(p1__16343_SHARP_))));
...
var vec__16372 = cljs.core.first(cvec_nl);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16372,(0),null);
var where = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16372,(1),null);
var cvec_element = vec__16372;
if((cvec_element == null)){
var G__16447 = cljs.core.next(cvec_nl);
var G__16448 = (idx + (1));
var G__16449 = start;
var G__16450 = out;
cvec_nl = G__16447;
...
if(cljs.core.truth_((function (){var and__5000__auto__ = cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(n,(1));
...
var G__16451 = cljs.core.next(cvec_nl);
var G__16452 = (idx + (1));
var G__16453 = idx;
var G__16454 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null));
cvec_nl = G__16451;
idx = G__16452;
start = G__16453;
out = G__16454;
...
var G__16455 = cljs.core.next(cvec_nl);
var G__16456 = (idx + (1));
var G__16457 = (idx + (1));
var G__16458 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null));
cvec_nl = G__16455;
idx = G__16456;
start = G__16457;
out = G__16458;
...
if(cljs.core.truth_((function (){var and__5000__auto__ = (n > (1));
if(and__5000__auto__){
var and__5000__auto____$1 = new cljs.core.Keyword(null,"b","b",1482224470).cljs$core$IFn$_invoke$arity$1(where);
...
var G__16459 = cljs.core.next(cvec_nl);
var G__16460 = (idx + (1));
var G__16461 = idx;
var G__16462 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,(idx - (1))], null)),cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [idx,idx], null)));
cvec_nl = G__16459;
idx = G__16460;
start = G__16461;
out = G__16462;
...
var G__16463 = cljs.core.next(cvec_nl);
var G__16464 = (idx + (1));
var G__16465 = start;
var G__16466 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.conj,out,cljs.core.repeat.cljs$core$IFn$_invoke$arity$2(n,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [start,idx], null)));
cvec_nl = G__16463;
idx = G__16464;
start = G__16465;
out = G__16466;
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__16390_SHARP_,p2__16389_SHARP_){
if(zprint.finish.within_QMARK_(idx,p2__16389_SHARP_)){
return cljs.core.reduced(p1__16390_SHARP_);
} else {
return (p1__16390_SHARP_ + (1));
}
}),(0),lines);
});
/**
 ...
 */
zprint.finish.surround_focus = (function zprint$finish$surround_focus(lines_to_cvec,p__16392,p__16393){
var vec__16394 = p__16392;
var focus_begin = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16394,(0),null);
var focus_end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16394,(1),null);
var vec__16397 = p__16393;
var before = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16397,(0),null);
var after = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16397,(1),null);
 ...
 */
zprint.finish.handle_lines = (function zprint$finish$handle_lines(p__16409,cvec,focus_vec){
var map__16410 = p__16409;
var map__16410__$1 = cljs.core.__destructure_map(map__16410);
var options = map__16410__$1;
var map__16411 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16410__$1,new cljs.core.Keyword(null,"output","output",-1105869043));
var map__16411__$1 = cljs.core.__destructure_map(map__16411);
var focus = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16411__$1,new cljs.core.Keyword(null,"focus","focus",234677911));
var lines = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16411__$1,new cljs.core.Keyword(null,"lines","lines",-700165781));
var paths = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16411__$1,new cljs.core.Keyword(null,"paths","paths",-1807389588));
if(cljs.core.truth_((function (){var or__5002__auto__ = lines;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
var or__5002__auto____$1 = paths;
...
var path_vecs__$1 = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16407_SHARP_){
return zprint.finish.surround_focus(lines_to_cvec,p1__16407_SHARP_,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(0),(0)], null));
}),path_vecs);
