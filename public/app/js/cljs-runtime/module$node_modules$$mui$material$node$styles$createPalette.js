shadow$provide.module$node_modules$$mui$material$node$styles$createPalette = function(global, require, module, exports) {
  function getLight() {
    return {text:{primary:"rgba(0, 0, 0, 0.87)", secondary:"rgba(0, 0, 0, 0.6)", disabled:"rgba(0, 0, 0, 0.38)"}, divider:"rgba(0, 0, 0, 0.12)", background:{paper:_common.default.white, default:_common.default.white}, action:{active:"rgba(0, 0, 0, 0.54)", hover:"rgba(0, 0, 0, 0.04)", hoverOpacity:0.04, selected:"rgba(0, 0, 0, 0.08)", selectedOpacity:0.08, disabled:"rgba(0, 0, 0, 0.26)", disabledBackground:"rgba(0, 0, 0, 0.12)", disabledOpacity:0.38, focus:"rgba(0, 0, 0, 0.12)", focusOpacity:0.12, 
    activatedOpacity:0.12}};
  }
  function getDark() {
    return {text:{primary:_common.default.white, secondary:"rgba(255, 255, 255, 0.7)", disabled:"rgba(255, 255, 255, 0.5)", icon:"rgba(255, 255, 255, 0.5)"}, divider:"rgba(255, 255, 255, 0.12)", background:{paper:"#121212", default:"#121212"}, action:{active:_common.default.white, hover:"rgba(255, 255, 255, 0.08)", hoverOpacity:0.08, selected:"rgba(255, 255, 255, 0.16)", selectedOpacity:0.16, disabled:"rgba(255, 255, 255, 0.3)", disabledBackground:"rgba(255, 255, 255, 0.12)", disabledOpacity:0.38, 
    focus:"rgba(255, 255, 255, 0.12)", focusOpacity:0.12, activatedOpacity:0.24}};
  }
  ...
  exports.default = function(palette) {
    ...
    const {mode = "light", contrastThreshold = 3, tonalOffset = 0.2, ...other} = palette, primary = palette.primary || getDefaultPrimary(mode), secondary = palette.secondary || getDefaultSecondary(mode), error = palette.error || getDefaultError(mode), info = palette.info || getDefaultInfo(mode), success = palette.success || getDefaultSuccess(mode);
    ...
    modeHydrated || console.error(`MUI: The palette mode \`${mode}\` is not supported.`);
    return (0,_deepmerge.default)({common:{..._common.default}, mode, primary:augmentColor({color:primary, name:"primary"}), secondary:augmentColor({color:secondary, name:"secondary", mainShade:"A400", lightShade:"A200", darkShade:"A700"}), error:augmentColor({color:error, name:"error"}), warning:augmentColor({color:palette, name:"warning"}), info:augmentColor({color:info, name:"info"}), success:augmentColor({color:success, name:"success"}), grey:_grey.default, contrastThreshold, getContrastText, 
    augmentColor, tonalOffset, ...modeHydrated}, other);
  };
  exports.light = void 0;
  global(require("module$node_modules$$mui$utils$formatMuiErrorMessage$index"));
  var _deepmerge = global(require("module$node_modules$$mui$utils$deepmerge$index")), _colorManipulator = require("module$node_modules$$mui$system$colorManipulator$index"), _common = global(require("module$node_modules$$mui$material$node$colors$common")), _grey = global(require("module$node_modules$$mui$material$node$colors$grey")), _purple = global(require("module$node_modules$$mui$material$node$colors$purple")), _red = global(require("module$node_modules$$mui$material$node$colors$red")), _orange = 
  ...
  const light = exports.light = getLight(), dark = exports.dark = getDark();
};
