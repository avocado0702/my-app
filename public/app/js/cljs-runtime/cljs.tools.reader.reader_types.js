...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_13919 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_13919(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_13922 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_13922(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13923 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_13923(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13924 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_13924(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13927 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_13927(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13929 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_13929(reader);
}
});
...
var G__13978 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__13979 = s.append(c);
c = G__13978;
s = G__13979;
continue;
}
