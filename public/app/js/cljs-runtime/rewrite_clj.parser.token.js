...
args__5732__auto__.push((arguments[i__5727__auto___18139]));
...
(rewrite_clj.parser.token.read_to_boundary.cljs$core$IFn$_invoke$arity$variadic = (function (reader,p__18106){
var vec__18111 = p__18106;
var allowed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18111,(0),null);
var allowed_QMARK_ = cljs.core.set(allowed);
return rewrite_clj.reader.read_until(reader,(function (p1__18099_SHARP_){
var and__5000__auto__ = cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__18099_SHARP_) : allowed_QMARK_.call(null, p1__18099_SHARP_)));
if(and__5000__auto__){
return rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__18099_SHARP_);
} else {
...
/** @this {Function} */
(rewrite_clj.parser.token.read_to_boundary.cljs$lang$applyTo = (function (seq18101){
