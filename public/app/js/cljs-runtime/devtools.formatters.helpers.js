...
var G__11481 = devtools.prefs.pref(v);
v = G__11481;
continue;
} else {
return v;
...
}catch (e11408){var _e__10778__auto__ = e11408;
return false;
}})();
...
}catch (e11411){var _e__10778__auto__ = e11411;
return false;
}})();
...
}catch (e11413){var _e__10778__auto__ = e11413;
return false;
}}
}
});
...
var vec__11442 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11442,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11442,(1),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11445_SHARP_);
}),template);
});
