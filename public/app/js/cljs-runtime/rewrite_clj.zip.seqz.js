...
var G__20904 = (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(zloc_n0) : f.call(null, zloc_n0));
var G__20904__$1 = (((G__20904 == null))?null:cljs.core.iterate((function (loc){
...
var G__20904__$2 = (((G__20904__$1 == null))?null:cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__20904__$1));
var G__20904__$3 = (((G__20904__$2 == null))?null:cljs.core.last(G__20904__$2));
if((G__20904__$3 == null)){
return null;
} else {
return rewrite_clj.zip.move.up(G__20904__$3);
}
} else {
return zloc;
}
...
var G__20942 = rewrite_clj.zip.move.right(new_zloc_map_value);
var G__20943 = rewrite_clj.zip.move.up(new_zloc_map_value);
loc = G__20942;
parent = G__20943;
continue;
} else {
var G__20944 = rewrite_clj.zip.move.right(zloc_map_value);
var G__20945 = parent;
loc = G__20944;
parent = G__20945;
continue;
...
var G__20946 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(zloc_map_key));
var G__20947 = rewrite_clj.zip.move.up(zloc_map_key);
loc = G__20946;
parent = G__20947;
continue;
} else {
var G__20948 = rewrite_clj.zip.move.right(rewrite_clj.zip.move.right(loc));
var G__20949 = parent;
loc = G__20948;
parent = G__20949;
continue;
...
var G__20931 = zloc;
var G__20931__$1 = (((G__20931 == null))?null:rewrite_clj.zip.move.down(G__20931));
var G__20931__$2 = (((G__20931__$1 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__20931__$1,k));
if((G__20931__$2 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__20931__$2);
}
} else {
if(rewrite_clj.zip.seqz.namespaced_map_QMARK_(zloc)){
var G__20932 = zloc;
var G__20932__$1 = (((G__20932 == null))?null:rewrite_clj.zip.move.down(G__20932));
var G__20932__$2 = (((G__20932__$1 == null))?null:rewrite_clj.zip.move.rightmost(G__20932__$1));
var G__20932__$3 = (((G__20932__$2 == null))?null:rewrite_clj.zip.move.down(G__20932__$2));
var G__20932__$4 = (((G__20932__$3 == null))?null:rewrite_clj.zip.findz.find_value.cljs$core$IFn$_invoke$arity$2(G__20932__$3,k));
if((G__20932__$4 == null)){
return null;
} else {
return rewrite_clj.zip.move.right(G__20932__$4);
}
} else {
return cljs.core.nth.cljs$core$IFn$_invoke$arity$2((function (){var G__20933 = rewrite_clj.zip.move.down(zloc);
var G__20933__$1 = (((G__20933 == null))?null:cljs.core.iterate(rewrite_clj.zip.move.right,G__20933));
if((G__20933__$1 == null)){
return null;
} else {
return cljs.core.take_while.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,G__20933__$1);
}
})(),k);
