...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"login-check","login-check",-1574399346),(function (p__26108,p__26109){
var map__26110 = p__26108;
var map__26110__$1 = cljs.core.__destructure_map(map__26110);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26110__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__26111 = p__26109;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26111,(0),null);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26111,(1),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26111,(2),null);
var users = new cljs.core.Keyword(null,"user-list","user-list",346594331).cljs$core$IFn$_invoke$arity$1(db);
var matched_user = cljs.core.some((function (p1__26106_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(p1__26106_SHARP_),username);
}),users);
var matcher_password = cljs.core.some((function (p1__26107_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(p1__26107_SHARP_),username)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"password","password",417022471).cljs$core$IFn$_invoke$arity$1(p1__26107_SHARP_),password)));
}),users);
...
re_frame.core.reg_event_fx.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"create-account","create-account",-1493050940),(function (p__26115,p__26116){
var map__26117 = p__26115;
var map__26117__$1 = cljs.core.__destructure_map(map__26117);
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26117__$1,new cljs.core.Keyword(null,"db","db",993250759));
var vec__26118 = p__26116;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26118,(0),null);
var username = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26118,(1),null);
var password = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26118,(2),null);
var password_confirm = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26118,(3),null);
if(cljs.core.truth_(cljs.core.some((function (p1__26114_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"username","username",1605666410).cljs$core$IFn$_invoke$arity$1(p1__26114_SHARP_),username);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-current-page","set-current-page",-1047328569),(function (db,p__26121){
var vec__26122 = p__26121;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26122,(0),null);
var page = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26122,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-login-status","set-login-status",-178040890),(function (db,p__26125){
var vec__26126 = p__26125;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26126,(0),null);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26126,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"set-login-error-message","set-login-error-message",-1556975842),(function (db,p__26129){
var vec__26130 = p__26129;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26130,(0),null);
var log_in_error_message = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26130,(1),null);
...
re_frame.core.reg_event_db.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"delete-item","delete-item",-1801247188),(function (db,p__26134){
var vec__26135 = p__26134;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26135,(0),null);
var item_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26135,(1),null);
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2((function (p1__26133_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__26133_SHARP_),item_id);
}),items);
}));
}));
