shadow$provide.module$node_modules$$mui$material$node$Modal$ModalManager = function(global, require, module, exports) {
  ...
  function ariaHidden(element, hide) {
    hide ? element.setAttribute("aria-hidden", "true") : element.removeAttribute("aria-hidden");
  }
  ...
  function ariaHiddenSiblings(container, mountElement, currentElement, elementsToExclude, hide) {
    ...
    [].forEach.call(container.children, element => {
      const isNotExcludedElement = !blacklist.includes(element), isForbiddenTagName = "TEMPLATE SCRIPT STYLE LINK MAP META NOSCRIPT PICTURE COL COLGROUP PARAM SLOT SOURCE TRACK".split(" ").includes(element.tagName), isInputHidden = "INPUT" === element.tagName && "hidden" === element.getAttribute("type");
      isNotExcludedElement && !isForbiddenTagName && !isInputHidden && ariaHidden(element, hide);
    });
  }
  ...
  function handleContainer(containerInfo, props) {
    ...
    if (!props.disableScrollLock) {
      if (isOverflowing(containerInfo)) {
        const scrollbarSize = (0,_utils.unstable_getScrollbarSize)((0,_utils.unstable_ownerWindow)(containerInfo));
      ...
      if (containerInfo.parentNode instanceof DocumentFragment) {
        ...
        containerInfo = "HTML" === props?.nodeName && "scroll" === containerWindow.getComputedStyle(props).overflowY ? props : containerInfo;
      }
  ...
  var _utils = require("module$node_modules$$mui$utils$index");
  class ModalManager {
    constructor() {
      this.modals = [];
      this.containers = [];
    ...
    mount(modal, props) {
      var containerIndex = findIndexOf(this.containers, item => item.modals.includes(modal));
    ...
    remove(modal, ariaHiddenState = !0) {
      ...
      const containerIndex = findIndexOf(this.containers, item => item.modals.includes(modal)), containerInfo = this.containers[containerIndex];
...
//# sourceMappingURL=module$node_modules$$mui$material$node$Modal$ModalManager.js.map
