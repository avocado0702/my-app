...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k16976,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16976,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__17011){
var vec__17015 = p__17011;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17015,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17015,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16975){
var self__ = this;
var G__16975__$1 = this;
return (new cljs.core.RecordIter((0),G__16975__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this16988,other16989){
var self__ = this;
var this16988__$1 = this;
return (((!((other16989 == null)))) && ((((this16988__$1.constructor === other16989.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16988__$1.tag,other16989.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16988__$1.format_string,other16989.format_string)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16988__$1.wrap_length,other16989.wrap_length)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16988__$1.seq_fn,other16989.seq_fn)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16988__$1.children,other16989.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16988__$1.__extmap,other16989.__extmap)))))))))))))));
}));
...
var self__ = this;
var _node__$1 = this;
var G__17071 = rewrite_clj.node.protocols.sexprs.cljs$core$IFn$_invoke$arity$2(self__.children,opts);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__17071) : self__.seq_fn.call(null, G__17071));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k16976){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k16976);

}
}));

(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__16975){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__17089 = cljs.core.keyword_identical_QMARK_;
var expr__17090 = k__5309__auto__;
if(cljs.core.truth_((pred__17089.cljs$core$IFn$_invoke$arity$2 ? pred__17089.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17090) : pred__17089.call(null, new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17090)))){
return (new rewrite_clj.node.seq.SeqNode(G__16975,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17089.cljs$core$IFn$_invoke$arity$2 ? pred__17089.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__17090) : pred__17089.call(null, new cljs.core.Keyword(null,"format-string","format-string",832187437),expr__17090)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__16975,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17089.cljs$core$IFn$_invoke$arity$2 ? pred__17089.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__17090) : pred__17089.call(null, new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),expr__17090)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,G__16975,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17089.cljs$core$IFn$_invoke$arity$2 ? pred__17089.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__17090) : pred__17089.call(null, new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),expr__17090)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,G__16975,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17089.cljs$core$IFn$_invoke$arity$2 ? pred__17089.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__17090) : pred__17089.call(null, new cljs.core.Keyword(null,"children","children",-940561982),expr__17090)))){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,G__16975,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__16975),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__16975){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.format_string,self__.wrap_length,self__.seq_fn,self__.children,G__16975,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__16993){
var extmap__5342__auto__ = (function (){var G__17115 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16993,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"format-string","format-string",832187437),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
...
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__16993),new cljs.core.Keyword(null,"format-string","format-string",832187437).cljs$core$IFn$_invoke$arity$1(G__16993),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__16993),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__16993),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__16993),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),"(%s)",(2),(function (p1__17126_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__17126_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),"{%s}",(2),(function (p1__17134_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__17134_SHARP_);
}),children);
});
