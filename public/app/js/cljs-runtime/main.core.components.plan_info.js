...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.plan-info","div.plan-info",-1890090358),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h2","h2",-372662728),["Plan Title: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"titel","titel",1985670278).cljs$core$IFn$_invoke$arity$1(current_plan))].join('')], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),["Plan description: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(current_plan))].join('')], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.tasks-info","div.tasks-info",1943238830),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"h3","h3",2067611163),"Your tasks:"], null),((cljs.core.seq(new cljs.core.Keyword(null,"tasks","tasks",-1754368880).cljs$core$IFn$_invoke$arity$1(current_plan)))?(function (){var iter__5480__auto__ = (function main$core$components$plan_info$plan_info_$_iter__26172(s__26173){
return (new cljs.core.LazySeq(null,(function (){
var s__26173__$1 = s__26173;
while(true){
var temp__5804__auto__ = cljs.core.seq(s__26173__$1);
if(temp__5804__auto__){
var s__26173__$2 = temp__5804__auto__;
if(cljs.core.chunked_seq_QMARK_(s__26173__$2)){
var c__5478__auto__ = cljs.core.chunk_first(s__26173__$2);
var size__5479__auto__ = cljs.core.count(c__5478__auto__);
var b__26175 = cljs.core.chunk_buffer(size__5479__auto__);
if((function (){var i__26174 = (0);
while(true){
if((i__26174 < size__5479__auto__)){
var task = cljs.core._nth(c__5478__auto__,i__26174);
cljs.core.chunk_append(b__26175,cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.task-item","div.task-item",-1998171877),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$mui$material$node$FormControlLabel$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"control","control",1892578036),reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$mui$material$node$Checkbox$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"checked","checked",-50955819),new cljs.core.Keyword(null,"is-completed","is-completed",-1839227074).cljs$core$IFn$_invoke$arity$1(task),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__26174,task,c__5478__auto__,size__5479__auto__,b__26175,s__26173__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_title,edited_text,last_item_id){
return (function (){
...
});})(i__26174,task,c__5478__auto__,size__5479__auto__,b__26175,s__26173__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_title,edited_text,last_item_id))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__26175),main$core$components$plan_info$plan_info_$_iter__26172(cljs.core.chunk_rest(s__26173__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__26175),null);
}
} else {
var task = cljs.core.first(s__26173__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.task-item","div.task-item",-1998171877),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$mui$material$node$FormControlLabel$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"control","control",1892578036),reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$mui$material$node$Checkbox$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"checked","checked",-50955819),new cljs.core.Keyword(null,"is-completed","is-completed",-1839227074).cljs$core$IFn$_invoke$arity$1(task),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (task,s__26173__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_title,edited_text,last_item_id){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-task-completion","toggle-task-completion",708129934),cljs.core.deref(selected_item_id),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null));
});})(task,s__26173__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_title,edited_text,last_item_id))
], null)], null)),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(task)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null)),main$core$components$plan_info$plan_info_$_iter__26172(cljs.core.rest(s__26173__$2)));
}
} else {
return null;
}
