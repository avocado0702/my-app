...
re_frame.core.dispatch(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"set-edit-mode","set-edit-mode",-1860679669),false], null));

return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"reset-edited-tasks","reset-edited-tasks",-1524896779)], null));
})], null),"Save"], null);
});
...
var edited_tasks = re_frame.core.subscribe.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"get-edited-tasks","get-edited-tasks",1145994367)], null));
...
});})(i__27690,task,c__5478__auto__,size__5479__auto__,b__27691,s__27689__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_tasks,edited_title,edited_text,last_item_id))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__27691),main$core$components$plan_info$plan_info_$_iter__27688(cljs.core.chunk_rest(s__27689__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__27691),null);
}
} else {
var task = cljs.core.first(s__27689__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.task-item","div.task-item",-1998171877),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$mui$material$node$FormControlLabel$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"control","control",1892578036),reagent.core.as_element.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,">",">",-555517146),module$node_modules$$mui$material$node$Checkbox$index.default,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"checked","checked",-50955819),new cljs.core.Keyword(null,"is-completed","is-completed",-1839227074).cljs$core$IFn$_invoke$arity$1(task),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (task,s__27689__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_tasks,edited_title,edited_text,last_item_id){
return (function (){
return re_frame.core.dispatch(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"toggle-task-completion","toggle-task-completion",708129934),cljs.core.deref(selected_item_id),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null));
});})(task,s__27689__$2,temp__5804__auto__,current_plan,edit_mode,selected_item_id,edited_tasks,edited_title,edited_text,last_item_id))
], null)], null)),new cljs.core.Keyword(null,"label","label",1718410804),new cljs.core.Keyword(null,"description","description",-1428560544).cljs$core$IFn$_invoke$arity$1(task)], null)], null)], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(task)], null)),main$core$components$plan_info$plan_info_$_iter__27688(cljs.core.rest(s__27689__$2)));
}
} else {
return null;
}
