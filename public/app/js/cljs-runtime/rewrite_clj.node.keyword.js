...
rewrite_clj.node.keyword.keyword_sexpr = (function rewrite_clj$node$keyword$keyword_sexpr(kw,kw_auto_resolved_QMARK_,map_qualifier,p__16585){
var map__16587 = p__16585;
var map__16587__$1 = cljs.core.__destructure_map(map__16587);
var auto_resolve = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16587__$1,new cljs.core.Keyword(null,"auto-resolve","auto-resolve",1851201983));
...
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2((function (){var G__16589 = (cljs.core.truth_(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(q))?(function (){var G__16591 = (function (){var or__5002__auto__ = (function (){var G__16592 = new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q);
if((G__16592 == null)){
return null;
} else {
return cljs.core.symbol.cljs$core$IFn$_invoke$arity$1(G__16592);
}
})();
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
...
var fexpr__16590 = (function (){var or__5002__auto__ = auto_resolve;
if(cljs.core.truth_(or__5002__auto__)){
return or__5002__auto__;
} else {
...
return (fexpr__16590.cljs$core$IFn$_invoke$arity$1 ? fexpr__16590.cljs$core$IFn$_invoke$arity$1(G__16591) : fexpr__16590.call(null, G__16591));
})():new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(q));
if((G__16589 == null)){
return null;
} else {
return cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16589);
}
})(),cljs.core.name(kw));
});
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k16603,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16603,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__16626){
var vec__16627 = p__16626;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16627,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16627,(1),null);
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this16604,other16605){
var self__ = this;
var this16604__$1 = this;
return (((!((other16605 == null)))) && ((((this16604__$1.constructor === other16605.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16604__$1.k,other16605.k)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16604__$1.auto_resolved_QMARK_,other16605.auto_resolved_QMARK_)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16604__$1.map_qualifier,other16605.map_qualifier)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16604__$1.__extmap,other16605.__extmap)))))))))));
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k16603){
var self__ = this;
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__16602){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__16678 = cljs.core.keyword_identical_QMARK_;
var expr__16679 = k__5309__auto__;
if(cljs.core.truth_((pred__16678.cljs$core$IFn$_invoke$arity$2 ? pred__16678.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"k","k",-2146297393),expr__16679) : pred__16678.call(null, new cljs.core.Keyword(null,"k","k",-2146297393),expr__16679)))){
return (new rewrite_clj.node.keyword.KeywordNode(G__16602,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__16678.cljs$core$IFn$_invoke$arity$2 ? pred__16678.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__16679) : pred__16678.call(null, new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),expr__16679)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,G__16602,self__.map_qualifier,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__16678.cljs$core$IFn$_invoke$arity$2 ? pred__16678.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__16679) : pred__16678.call(null, new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720),expr__16679)))){
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,G__16602,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__16602),null));
}
}
}
}));
...
(rewrite_clj.node.keyword.KeywordNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__16602){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.keyword.KeywordNode(self__.k,self__.auto_resolved_QMARK_,self__.map_qualifier,G__16602,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.keyword.map__GT_KeywordNode = (function rewrite_clj$node$keyword$map__GT_KeywordNode(G__16610){
var extmap__5342__auto__ = (function (){var G__16696 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16610,new cljs.core.Keyword(null,"k","k",-2146297393),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720)], 0));
...
return (new rewrite_clj.node.keyword.KeywordNode(new cljs.core.Keyword(null,"k","k",-2146297393).cljs$core$IFn$_invoke$arity$1(G__16610),new cljs.core.Keyword(null,"auto-resolved?","auto-resolved?",-1944476351).cljs$core$IFn$_invoke$arity$1(G__16610),new cljs.core.Keyword(null,"map-qualifier","map-qualifier",-1248117720).cljs$core$IFn$_invoke$arity$1(G__16610),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
