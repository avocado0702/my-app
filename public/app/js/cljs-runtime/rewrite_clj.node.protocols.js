...
var rewrite_clj$node$protocols$Node$tag$dyn_16480 = (function (node){
...
return rewrite_clj$node$protocols$Node$tag$dyn_16480(node);
}
});

var rewrite_clj$node$protocols$Node$node_type$dyn_16486 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$node_type$dyn_16486(node);
}
});

var rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_16487 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$printable_only_QMARK_$dyn_16487(node);
}
});

var rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_16488 = (function (node,opts){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$sexpr_STAR_$dyn_16488(node,opts);
}
});

var rewrite_clj$node$protocols$Node$length$dyn_16490 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$length$dyn_16490(node);
}
});

var rewrite_clj$node$protocols$Node$string$dyn_16491 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$Node$string$dyn_16491(node);
}
});
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__16371_SHARP_){
return rewrite_clj.node.protocols.sexpr.cljs$core$IFn$_invoke$arity$2(p1__16371_SHARP_,opts);
...
var rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_16514 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$inner_QMARK_$dyn_16514(node);
}
});

var rewrite_clj$node$protocols$InnerNode$children$dyn_16516 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$children$dyn_16516(node);
}
});

var rewrite_clj$node$protocols$InnerNode$replace_children$dyn_16521 = (function (node,children){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$replace_children$dyn_16521(node,children);
}
});

var rewrite_clj$node$protocols$InnerNode$leader_length$dyn_16523 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$InnerNode$leader_length$dyn_16523(node);
}
});
...
var rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_16540 = (function (form){
...
return rewrite_clj$node$protocols$NodeCoerceable$coerce$dyn_16540(form);
}
});
...
var rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_16541 = (function (node,map_qualifier){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_apply$dyn_16541(node,map_qualifier);
}
});

var rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_16543 = (function (node){
var x__5350__auto__ = (((node == null))?null:node);
...
return rewrite_clj$node$protocols$MapQualifiable$map_context_clear$dyn_16543(node);
}
});
...
var map__16469 = cljs.core.meta(node);
var map__16469__$1 = cljs.core.__destructure_map(map__16469);
var row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16469__$1,new cljs.core.Keyword(null,"row","row",-570139521));
var col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16469__$1,new cljs.core.Keyword(null,"col","col",-1959363084));
var next_row = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16469__$1,new cljs.core.Keyword(null,"next-row","next-row",-408963777));
var next_col = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16469__$1,new cljs.core.Keyword(null,"next-col","next-col",601697889));
...
rewrite_clj.node.protocols._PLUS_extent = (function rewrite_clj$node$protocols$_PLUS_extent(p__16470,p__16471){
var vec__16472 = p__16470;
var row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16472,(0),null);
var col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16472,(1),null);
var vec__16475 = p__16471;
var row_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16475,(0),null);
var col_extent = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16475,(1),null);
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(row + row_extent),(function (){var G__16478 = col_extent;
if((row_extent === (0))){
return (G__16478 + col);
} else {
return G__16478;
...
if(cljs.core.truth_(rewrite_clj.node.protocols.inner_QMARK_(node))){
var G__16479 = rewrite_clj.node.protocols.children(node);
var G__16479__$1 = (((G__16479 == null))?null:cljs.core.first(G__16479));
if((G__16479__$1 == null)){
return null;
} else {
return cljs.core.juxt.cljs$core$IFn$_invoke$arity$2(rewrite_clj.node.protocols.tag,rewrite_clj.node.protocols.sexpr)(G__16479__$1);
}
} else {
