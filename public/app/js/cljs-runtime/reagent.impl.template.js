...
var G__18436 = o;
reagent.impl.template.goog$module$goog$object.set(G__18436,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
return (function() { 
var G__18668__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__18668 = function (var_args){
var args = null;
...
return G__18668__delegate.call(this,args);};
G__18668.cljs$lang$maxFixedArity = 0;
G__18668.cljs$lang$applyTo = (function (arglist__18670){
var args = cljs.core.seq(arglist__18670);
return G__18668__delegate(args);
});
...
var G__18473 = o;
reagent.impl.template.goog$module$goog$object.set(G__18473,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__18675.cljs$lang$applyTo = (function (arglist__18679){
...
var G__18484 = props;
var G__18484__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18484,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__18484);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18484__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__18500 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__18500,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__18500;
}
})(),id_class);
...
var G__18501 = (cljs.core.count(argv) - first_child);
switch (G__18501) {
case (0):
...
var vec__18514 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18514,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18514,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18514,(2),null);
...
var temp__5808__auto___18721 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___18721 == null)){
} else {
var key_18722 = temp__5808__auto___18721;
(jsprops.key = key_18722);
}
...
var temp__5808__auto___18725 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___18725 == null)){
} else {
var key_18726 = temp__5808__auto___18725;
(jsprops.key = key_18726);
}
...
var temp__5808__auto___18728 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___18728 == null)){
} else {
var key_18729 = temp__5808__auto___18728;
(jsprops.key = key_18729);
}
...
var temp__5808__auto___18731 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___18731 == null)){
} else {
var key_18732 = temp__5808__auto___18731;
(jsprops.key = key_18732);
}
...
var temp__5808__auto___18733 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___18733 == null)){
} else {
var key_18734 = temp__5808__auto___18733;
(jsprops.key = key_18734);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__18585_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__18585_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__18586 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18586,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__18586,(1),null);
...
break;
default:
var G__18752 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__18753 = compiler;
v = G__18752;
compiler = G__18753;
continue;
...
*/
reagent.impl.template.t_reagent$impl$template18631 = (function (opts,id,fn_to_element,parse_fn,meta18632){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template18631.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_18633,meta18632__$1){
var self__ = this;
var _18633__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template18631(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta18632__$1));
}));

(reagent.impl.template.t_reagent$impl$template18631.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_18633){
var self__ = this;
var _18633__$1 = this;
return self__.meta18632;
}));

(reagent.impl.template.t_reagent$impl$template18631.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template18631.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template18631.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template18631.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template18631.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template18631.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta18632","meta18632",1028401407,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template18631.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template18631.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template18631");

(reagent.impl.template.t_reagent$impl$template18631.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template18631");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template18631.
 */
reagent.impl.template.__GT_t_reagent$impl$template18631 = (function reagent$impl$template$__GT_t_reagent$impl$template18631(opts,id,fn_to_element,parse_fn,meta18632){
return (new reagent.impl.template.t_reagent$impl$template18631(opts,id,fn_to_element,parse_fn,meta18632));
});
...
return (new reagent.impl.template.t_reagent$impl$template18631(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
