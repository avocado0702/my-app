...
var o10914 = temp__5802__auto__;
var temp__5802__auto____$1 = (o10914["core"]);
if(cljs.core.truth_(temp__5802__auto____$1)){
var o10915 = temp__5802__auto____$1;
return (o10915["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10762__auto__ = f;
return (o__10762__auto__["toString"]).call(o__10762__auto__);
} else {
return "";
}
}catch (e10920){var _ = e10920;
return "";
}});
...
try{var o__10762__auto___11262 = t;
(o__10762__auto___11262["cljs$lang$ctorPrWriter"]).call(o__10762__auto___11262,t,writer);
}catch (e10924){var __11263 = e10924;
}
...
var char_code = (function (){var o__10762__auto__ = (new String(char$));
return (o__10762__auto__["charCodeAt"]).call(o__10762__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10762__auto__ = String;
return (o__10762__auto__["fromCharCode"]).call(o__10762__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__10955 = num_code;
switch (G__10955) {
case (1):
return (185);
...
var o__10762__auto__ = String;
return (o__10762__auto__["fromCharCode"]).call(o__10762__auto__,superscript_code);
});
/**
...
}catch (e10980){var _e__10778__auto__ = e10980;
return false;
}})())){
...
var vec__10983 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10983,(0),null);
...
args__5732__auto__.push((arguments[i__5727__auto___11275]));
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11004){
var vec__11005 = p__11004;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11005,(0),null);
...
var G__11278 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__11279 = cljs.core.butlast(remaining_tokens);
name_tokens = G__11278;
remaining_tokens = G__11279;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq10999){
var G__11000 = cljs.core.first(seq10999);
var seq10999__$1 = cljs.core.next(seq10999);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11000,seq10999__$1);
}));
...
var vec__11015 = cljs.core.split_with((function (p1__11014_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__11014_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11015,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11015,(1),null);
...
var vec__11026 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11026,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11026,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__11283 = cljs.core.rest(remaining_tokens);
var G__11284 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__11283;
name_tokens = G__11284;
continue;
} else {
...
var vec__11039 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11039,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11039,(1),null);
var vec__11042 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11042,(1),null);
var vec__11045 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11045,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11045,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11045,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11045,(3),null);
...
var vec__11067 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11067,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11067,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11067,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11067,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11067,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11067,(5),null);
...
if(cljs.core.truth_(temp__5802__auto__)){
var vec__11074 = temp__5802__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11074,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11074,(1),null);
var vec__11077 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11077,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11077,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__11086 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__11086) : devtools.munging.parse_fn_info_deep.call(null, G__11086));
})()));
}
} else {
return fn_info;
...
var G__11308 = (arity + (1));
var G__11309 = (function (){var temp__5802__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5802__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11116){
var vec__11118 = p__11116;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11118,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11118,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11148_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__11148_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11149_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__11149_SHARP_);
}),sorted_infos);
...
var args__5732__auto__ = [];
var len__5726__auto___11321 = arguments.length;
var i__5727__auto___11322 = (0);
while(true){
if((i__5727__auto___11322 < len__5726__auto___11321)){
args__5732__auto__.push((arguments[i__5727__auto___11322]));

var G__11327 = (i__5727__auto___11322 + (1));
i__5727__auto___11322 = G__11327;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11158){
var vec__11159 = p__11158;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11159,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11154){
var G__11155 = cljs.core.first(seq11154);
var seq11154__$1 = cljs.core.next(seq11154);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11155,seq11154__$1);
}));
...
var G__11166 = arg;
var G__11166__$1 = (((G__11166 instanceof cljs.core.Keyword))?G__11166.fqn:null);
switch (G__11166__$1) {
...
var map__11200 = options;
var map__11200__$1 = cljs.core.__destructure_map(map__11200);
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11200__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11200__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11200__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11200__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11201 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11201,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11201,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11201,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11201,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11201,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11201,(5),null);
...
var o__10762__auto__ = f;
return (o__10762__auto__["getBasis"]).call(o__10762__auto__);
});
/**
...
}catch (e11208){var _e__10778__auto__ = e11208;
...
var G__11340 = (obj[cljs.core.first(path)]);
var G__11341 = cljs.core.rest(path);
obj = G__11340;
path = G__11341;
continue;
} else {
...
var _STAR_ = (function (accum,p__11238){
var vec__11239 = p__11238;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11239,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11239,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11243){
var vec__11244 = p__11243;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11244,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11244,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11244,(2),null);
...
var post_process = (function (p__11253){
var vec__11254 = p__11253;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11254,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__11254,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__11248_SHARP_){
return (obj[cljs.core.first(p1__11248_SHARP_)]);
}),sorted_matches);
