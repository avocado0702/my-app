...
var G__30763 = rewrite_clj.zip.next(n);
loc = G__30763;
continue;
} else {
var G__30764 = rewrite_clj.zip.next(loc);
loc = G__30764;
continue;
}
} else {
var G__30765 = rewrite_clj.zip.next(loc);
loc = G__30765;
continue;
}
}
...
return rewrite_clj.zip.replace(zloc,rewrite_clj.zip.root(zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__30702 = zloc;
var G__30702__$1 = (((G__30702 == null))?null:rewrite_clj.zip.node(G__30702));
if((G__30702__$1 == null)){
return null;
} else {
return rewrite_clj.zip.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__30702__$1);
}
})())));
});
/**
...
var G__30770 = rewrite_clj.zip.down(nloc);
nloc = G__30770;
continue;
}
break;
...
var G__30771 = rewrite_clj.zip.right(nloc);
var G__30772 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__30771;
out = G__30772;
continue;
} else {
...
var G__30778 = rewrite_clj.zip.right(replaced_loc);
var G__30779 = cljs.core.next(new_loc);
var G__30780 = replaced_loc;
nloc = G__30778;
new_loc = G__30779;
last_loc = G__30780;
continue;
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__30747_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.tag(p1__30747_SHARP_),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.sexpr(p1__30747_SHARP_),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
