...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k16972,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16972,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__17027){
var vec__17028 = p__17027;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17028,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17028,(1),null);
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16971){
var self__ = this;
var G__16971__$1 = this;
return (new cljs.core.RecordIter((0),G__16971__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this16984,other16985){
var self__ = this;
var this16984__$1 = this;
return (((!((other16985 == null)))) && ((((this16984__$1.constructor === other16985.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16984__$1.tag,other16985.tag)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16984__$1.prefix,other16985.prefix)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16984__$1.sym,other16985.sym)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16984__$1.children,other16985.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16984__$1.__extmap,other16985.__extmap)))))))))))));
}));
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k16972){
var self__ = this;
var this__5307__auto____$1 = this;
var G__17088 = k16972;
var G__17088__$1 = (((G__17088 instanceof cljs.core.Keyword))?G__17088.fqn:null);
switch (G__17088__$1) {
case "tag":
case "prefix":
case "sym":
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k16972);

}
}));

(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__16971){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__17094 = cljs.core.keyword_identical_QMARK_;
var expr__17095 = k__5309__auto__;
if(cljs.core.truth_((pred__17094.cljs$core$IFn$_invoke$arity$2 ? pred__17094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17095) : pred__17094.call(null, new cljs.core.Keyword(null,"tag","tag",-1290361223),expr__17095)))){
return (new rewrite_clj.node.quote.QuoteNode(G__16971,self__.prefix,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17094.cljs$core$IFn$_invoke$arity$2 ? pred__17094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__17095) : pred__17094.call(null, new cljs.core.Keyword(null,"prefix","prefix",-265908465),expr__17095)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,G__16971,self__.sym,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17094.cljs$core$IFn$_invoke$arity$2 ? pred__17094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__17095) : pred__17094.call(null, new cljs.core.Keyword(null,"sym","sym",-1444860305),expr__17095)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,G__16971,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((pred__17094.cljs$core$IFn$_invoke$arity$2 ? pred__17094.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"children","children",-940561982),expr__17095) : pred__17094.call(null, new cljs.core.Keyword(null,"children","children",-940561982),expr__17095)))){
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,G__16971,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__16971),null));
}
}
}
}
...
(rewrite_clj.node.quote.QuoteNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__16971){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.quote.QuoteNode(self__.tag,self__.prefix,self__.sym,self__.children,G__16971,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.quote.map__GT_QuoteNode = (function rewrite_clj$node$quote$map__GT_QuoteNode(G__16991){
var extmap__5342__auto__ = (function (){var G__17123 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__16991,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prefix","prefix",-265908465),new cljs.core.Keyword(null,"sym","sym",-1444860305),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__16991)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17123);
} else {
return G__17123;
}
})();
return (new rewrite_clj.node.quote.QuoteNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__16991),new cljs.core.Keyword(null,"prefix","prefix",-265908465).cljs$core$IFn$_invoke$arity$1(G__16991),new cljs.core.Keyword(null,"sym","sym",-1444860305).cljs$core$IFn$_invoke$arity$1(G__16991),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__16991),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
...
var G__17229 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__17229;
continue;
}
break;
...
var G__17231 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__17231;
continue;
}
break;
...
var G__17232 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__17232;
continue;
}
break;
...
var G__17236 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [children], null);
children = G__17236;
continue;
}
break;
