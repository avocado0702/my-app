...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__5302__auto__,k16974,else__5303__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k16974,else__5303__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__5323__auto__,p__17012){
var vec__17020 = p__17012;
var k__5324__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17020,(0),null);
var v__5325__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__17020,(1),null);
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__16973){
var self__ = this;
var G__16973__$1 = this;
return (new cljs.core.RecordIter((0),G__16973__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"pattern","pattern",242135423)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this16986,other16987){
var self__ = this;
var this16986__$1 = this;
return (((!((other16987 == null)))) && ((((this16986__$1.constructor === other16987.constructor)) && (((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16986__$1.pattern,other16987.pattern)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this16986__$1.__extmap,other16987.__extmap)))))));
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_contains_key_QMARK_$arity$2 = (function (this__5307__auto__,k16974){
var self__ = this;
...
break;
default:
return cljs.core.contains_QMARK_(self__.__extmap,k16974);

}
}));

(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__5308__auto__,k__5309__auto__,G__16973){
var self__ = this;
var this__5308__auto____$1 = this;
var pred__17076 = cljs.core.keyword_identical_QMARK_;
var expr__17077 = k__5309__auto__;
if(cljs.core.truth_((pred__17076.cljs$core$IFn$_invoke$arity$2 ? pred__17076.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__17077) : pred__17076.call(null, new cljs.core.Keyword(null,"pattern","pattern",242135423),expr__17077)))){
return (new rewrite_clj.node.regex.RegexNode(G__16973,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__5309__auto__,G__16973),null));
}
}));
...
(rewrite_clj.node.regex.RegexNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__5299__auto__,G__16973){
var self__ = this;
var this__5299__auto____$1 = this;
return (new rewrite_clj.node.regex.RegexNode(self__.pattern,G__16973,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.regex.map__GT_RegexNode = (function rewrite_clj$node$regex$map__GT_RegexNode(G__16992){
var extmap__5342__auto__ = (function (){var G__17098 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__16992,new cljs.core.Keyword(null,"pattern","pattern",242135423));
if(cljs.core.record_QMARK_(G__16992)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__17098);
} else {
return G__17098;
}
})();
return (new rewrite_clj.node.regex.RegexNode(new cljs.core.Keyword(null,"pattern","pattern",242135423).cljs$core$IFn$_invoke$arity$1(G__16992),null,cljs.core.not_empty(extmap__5342__auto__),null));
});
