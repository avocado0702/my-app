...
var len__5726__auto___20385 = arguments.length;
var i__5727__auto___20386 = (0);
while(true){
if((i__5727__auto___20386 < len__5726__auto___20385)){
args__5732__auto__.push((arguments[i__5727__auto___20386]));

var G__20387 = (i__5727__auto___20386 + (1));
i__5727__auto___20386 = G__20387;
continue;
} else {
}
break;
...
(rewrite_clj.zip.findz.tag_predicate.cljs$core$IFn$_invoke$arity$variadic = (function (t,p__20259){
var vec__20263 = p__20259;
var additional = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20263,(0),null);
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__20254_SHARP_),t);
});
}
}));
...
/** @this {Function} */
(rewrite_clj.zip.findz.tag_predicate.cljs$lang$applyTo = (function (seq20255){
var G__20256 = cljs.core.first(seq20255);
var seq20255__$1 = cljs.core.next(seq20255);
var self__5711__auto__ = this;
return self__5711__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20256,seq20255__$1);
}));

rewrite_clj.zip.findz.position_in_range_QMARK_ = (function rewrite_clj$zip$findz$position_in_range_QMARK_(zloc,pos){
var vec__20271 = ((cljs.core.map_QMARK_(pos))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"row","row",-570139521).cljs$core$IFn$_invoke$arity$1(pos),new cljs.core.Keyword(null,"col","col",-1959363084).cljs$core$IFn$_invoke$arity$1(pos)], null):pos);
var r = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20271,(0),null);
var c = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20271,(1),null);
if((((r <= (0))) || ((c <= (0))))){
...
var vec__20276 = rewrite_clj.custom_zipper.core.position_span(zloc);
var vec__20279 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20276,(0),null);
var zstart_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20279,(0),null);
var zstart_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20279,(1),null);
var vec__20282 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20276,(1),null);
var zend_row = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20282,(0),null);
var zend_col = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__20282,(1),null);
...
return cljs.core.last(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__20304_SHARP_){
var and__5000__auto__ = (p_QMARK_.cljs$core$IFn$_invoke$arity$1 ? p_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__20304_SHARP_) : p_QMARK_.call(null, p1__20304_SHARP_));
if(cljs.core.truth_(and__5000__auto__)){
return rewrite_clj.zip.findz.position_in_range_QMARK_(p1__20304_SHARP_,pos);
} else {
return and__5000__auto__;
}
...
var G__20318 = zloc;
var G__20318__$1 = (((G__20318 == null))?null:(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__20318) : f.call(null, G__20318)));
if((G__20318__$1 == null)){
return null;
} else {
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(G__20318__$1,f,p_QMARK_);
}
}));
...
return rewrite_clj.zip.findz.find.cljs$core$IFn$_invoke$arity$3(zloc,f,(function (p1__20326_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__20326_SHARP_),t);
}));
}));
...
return rewrite_clj.zip.findz.find_last_by_pos.cljs$core$IFn$_invoke$arity$3(zloc,pos,(function (p1__20342_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.tag(p1__20342_SHARP_),t);
}));
});
/**
...
var p_QMARK_ = ((cljs.core.set_QMARK_(v))?cljs.core.comp.cljs$core$IFn$_invoke$arity$2(v,rewrite_clj.zip.base.sexpr):(function (p1__20372_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(rewrite_clj.zip.base.sexpr(p1__20372_SHARP_),v);
}));
