...
var i_14995 = (self__.level + (1));
while(true){
if((i_14995 <= (new_level + (1)))){
(update[i_14995] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_14998 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_14998[i]));
} else {
x__$2.forward.push((((i < links_14998.length))?(links_14998[i]):null));
}

if((i < links_14998.length)){
(links_14998[i] = x__$2);
} else {
links_14998.push(x__$2);
}
...
var i_15006 = (0);
while(true){
if((i_15006 <= self__.level)){
var links_15007 = (update[i_15006]).forward;
if((x__$1 === (((i_15006 < links_15007.length))?(links_15007[i_15006]):null))){
(links_15007[i_15006] = (x__$1.forward[i_15006]));

var G__15008 = (i_15006 + (1));
i_15006 = G__15008;
continue;
} else {
var G__15009 = (i_15006 + (1));
i_15006 = G__15009;
continue;
}
} else {
...
var G__15022 = nx;
var G__15023 = (level__$1 - (1));
x = G__15022;
level__$1 = G__15023;
continue;
} else {
var G__15024 = x;
var G__15025 = (level__$1 - (1));
x = G__15024;
level__$1 = G__15025;
continue;
}
