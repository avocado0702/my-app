...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11663 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_11663(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_11672 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_11672(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_11679 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_11679(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_11680 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_11680(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11696 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_11696(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11706 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_11706(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__11651,callback){
var map__11652 = p__11651;
var map__11652__$1 = cljs.core.__destructure_map(map__11652);
var input = map__11652__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11652__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__11652__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
