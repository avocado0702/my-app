...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"get-edited-tasks","get-edited-tasks",1145994367),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,_){
return new cljs.core.Keyword(null,"edited-tasks","edited-tasks",-1118231165).cljs$core$IFn$_invoke$arity$1(db);
})], 0));
...
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"get-plan-by-id","get-plan-by-id",533294233),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__27269){
var vec__27270 = p__27269;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27270,(0),null);
var plan_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27270,(1),null);
return cljs.core.first(cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__27268_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__27268_SHARP_),plan_id);
}),new cljs.core.Keyword(null,"plan-list","plan-list",672205601).cljs$core$IFn$_invoke$arity$1(db)));
})], 0));
re_frame.core.reg_sub.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"tasks-by-plan-id","tasks-by-plan-id",-1050020363),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(function (db,p__27274){
var vec__27275 = p__27274;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27275,(0),null);
var plan_id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27275,(1),null);
console.log("Fetching tasks for plan id:",plan_id);

var plan = cljs.core.some((function (p1__27273_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(p1__27273_SHARP_),plan_id)){
